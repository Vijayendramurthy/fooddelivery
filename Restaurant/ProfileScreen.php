...
// Ensure the user is logged in and is a restaurant
$user_id = $_SESSION['user_id'];

// Fetch restaurant details
$restaurant = [];
try {
    $stmt = $pdo->prepare("SELECT * FROM users WHERE id = ? AND role = 'restaurant'");
...
<div class="container">
    ...
    <form method="POST">
        ...
        <input type="text" id="phone" name="phone" value="<?php echo htmlspecialchars($restaurant['phone_number'] ?? ''); ?>" required>
